...
const dict = {
  kk: {
    ...
    hero_tag: "AI-негізді internship career OS",
    hero: "Жеке кабинет",
    hero_desc: "Тіркелу, CV жүктеу, стажировка пайызы және roadmap.",
    ...
    hero_chip_1: "Ерекше CV жаса",
    hero_chip_2: "AI match балын ал",
    hero_chip_3: "Топ стажировкаға өт",
  ...
  ru: {
    ...
    eyebrow: "AI INTERNSHIP PLATFORM",
    hero_tag: "AI-native internship career OS",
    hero: "Личный кабинет",
    hero_desc: "Регистрация, загрузка CV, процент стажировок и roadmap.",
    ...
    cta_bot: "Telegram-бот @skillbridgeebot",
    hero_chip_1: "Создай сильное CV",
    hero_chip_2: "Получи AI match score",
    hero_chip_3: "Получи топ-стажировку",
  ...
  en: {
    ...
    eyebrow: "AI INTERNSHIP PLATFORM",
    hero_tag: "AI-native internship career OS",
    hero: "Personal dashboard",
    hero_desc: "Register, upload CV, get internship match score and roadmap.",
    ...
    hero_chip_1: "Build standout CV",
    hero_chip_2: "Get AI match score",
    hero_chip_3: "Land top internship",
    kpi_user_id: "User ID",
    kpi_cv_id: "CV ID",
